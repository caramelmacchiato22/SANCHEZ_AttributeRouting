using SANCHEZ_AttributeRouting.Models;
using System.Data;
...
namespace SANCHEZ_AttributeRouting.Controllers
{
    //SIR DI KO PO ALAM BAKIT HINDI NIYA MAKITA RESOURCES. :((((
    ...
    public class ProductsController : ApiController
    {
        ...
        ////POST Provide Error Handling
        //public IHttpActionResult AddProductAndCategory(Product product)

        //DELETE by Product Code  
        [Route("{code}")]
        [Route("Delete/{code}")]
        public IHttpActionResult DeleteByProductCode(int id)
        {
            Product product = db.Product.Find(id);
            if (product == null)
            {
